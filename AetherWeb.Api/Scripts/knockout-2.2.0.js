...
(function() {
    ...
    function i(v) { throw v; }

    var l = !0, n = null, q = !1;

    function t(v) { return function() { return v; }; }
    ...
    function K(v) {
        ...
        function ga(a, d, c, e, f) {
            var g = [], a = b.j(function() {
                ...
                g.splice(0, g.length);
                b.a.P(g, a);
            }, n, { W: a, Ja: function() { return 0 == g.length || !b.a.X(g[0]); } });
        ...
        function R(a, b, c, e, f) {
            ...
            u = [];
            k = m;
            for (p = r; k || p;) r = j[k][p] - 1, p && r === j[k][p - 1] ? h.push(g[g.length] = { status: c, value: b[--p], index: p }) : k && r === j[k - 1][p] ? u.push(g[g.length] = { status: e, value: a[--k], index: k }) : (g.push({ status: "retained", value: b[--p] }), --k);
        ...
        function M(a) { return a.nodeType ? a : 0 < a.length ? a[0] : n; }

        function T(a, d) {
            if (a.length) {
                var c = a[0], e = a[a.length - 1];
                U(c, e, function(a) { b.Ca(d, a); });
                U(c, e, function(a) { b.s.hb(a, [d]); });
            }
        }

        function U(a, d, c) { for (var e, d = b.e.nextSibling(d); a && (e = a) !== d;) a = b.e.nextSibling(e), (1 === e.nodeType || 8 === e.nodeType) && c(e); }
        ...
        function W(a, d, c, e) {
            ...
            function f(a) { return function() { return j[a]; }; }
        ...
        function Y(a, d, c) { for (var e = b.e.firstChild(d); d = e;) e = b.e.nextSibling(d), X(a, d, c); }
        ...
        function G(a) { return 8 == a.nodeType && (J ? a.text : a.nodeValue).match(ha); }

        function A(a) { return 8 == a.nodeType && (J ? a.text : a.nodeValue).match(ia); }

        function O(a, b) {
            for (var c = n; a != c;) c = a, a = a.replace(ja, function(a, c) { return b[c]; });
            return a;
        }
        ...
        b.a = new function() {
            ...
            return {
                ...
                o: function(a, b) { for (var d = 0, c = a.length; d < c; d++) b(a[d]); },
                i: function(a, b) {
                ...
                ka: function(a) { for (; a.firstChild;) b.removeNode(a.firstChild); },
                Gb: function(a) {
                ...
                ab: function(a, b) { 7 > m ? a.setAttribute("selected", b) : a.selected = b; },
                D: function(a) { return (a || "").replace(d, ""); },
                Qb: function(a, d) {
                ...
                X: function(a) { return b.a.sb(a, a.ownerDocument); },
                ...
                d: function(a) { return b.$(a) ? a() : a; },
                ta: function(a) { return b.$(a) ? a.t() : a; },
                da: function(a, d, c) {
                    if (d) {
                ...
                vb: function(a) { 9 <= m && (a = 1 == a.nodeType ? a : a.parentNode, a.style && (a.style.zoom = a.style.zoom)); },
                tb: function(a) {
                    if (9 <= m) {
                        var b = a.style.width;
                        a.style.width = 0;
                ...
                Z: m,
                Na: function(a, d) {
                    for (var c = b.a.L(a.getElementsByTagName("input")).concat(b.a.L(a.getElementsByTagName("textarea"))), e = "string" == typeof d ? function(a) { return a.name === d; } : function(a) { return d.test(a.name); }, f = [], g = c.length - 1; 0 <= g; g--) e(c[g]) && f.push(c[g]);
                    return f;
                },
                Hb: function(a) { return "string" == typeof a && (a = b.a.D(a)) ? w.JSON && w.JSON.parse ? w.JSON.parse(a) : (new Function("return " + a))() : n; },
                wa: function(a, d, c) {
        ...
        Function.prototype.bind || (Function.prototype.bind = function(a) {
            ...
            return function() { return b.apply(a, c.concat(Array.prototype.slice.call(arguments))); };
        });
        b.a.f = new function() {
            ...
            return {
                ...
                set: function(a, d, c) { c === H && b.a.f.getAll(a, q) === H || (b.a.f.getAll(a, l)[d] = c); },
                getAll: function(b, f) {
                    var g = b[d];
                    if (!g || !("null" !== g && c[g])) {
                        if (!f) return H;
        ...
        b.a.ca = function(a, d) {
            ...
            d = b.a.d(d);
            if (d !== n && d !== H)
                if ("string" != typeof d && (d = d.toString()), "undefined" != typeof E) E(a).html(d);
                else
                    for (var c =
        ...
        b.s = {
            ...
            Ta: function(a) { return (a = a.match(/^\[ko_memo\:(.*?)\]$/)) ? a[1] : n; }
        };
        b.b("memoization", b.s);
        ...
        b.S.fn = {
            xa: function(a, d, c) {
                var c = c || "change", a = d ? a.bind(d) : a, e = new b.eb(this, a, function() { b.a.ga(this.w[c], e); }.bind(this));
                this.w[c] || (this.w[c] = []);
                this.w[c].push(e);
                return e;
            },
            notifySubscribers: function(a, d) {
                d = d || "change";
                this.w[d] && b.r.K(function() { b.a.o(this.w[d].slice(0), function(b) { b && b.Bb !== l && b.ha(a); }); }, this);
            },
            xb: function() {
                var a = 0, b;
        ...
        b.Pa = function(a) { return "function" == typeof a.xa && "function" == typeof a.notifySubscribers; };
        ...
        b.m = function(a) {
            ...
            var c = a;
            b.S.call(d);
            d.t = function() { return c; };
            d.G = function() { d.notifySubscribers(c); };
            d.H = function() { d.notifySubscribers(c, "beforeChange"); };
            b.a.extend(d, b.m.fn);
            b.p(d, "peek", d.t);
        ...
        b.m.fn[D] = b.m;
        b.la = function(a, d) { return a === n || a === H || a[D] === H ? q : a[D] === d ? l : b.la(a[D], d); };
        b.$ = function(a) { return b.la(a, b.m); };
        b.Qa = function(a) { return "function" == typeof a && a[D] === b.m || "function" == typeof a && a[D] === b.j && a.yb ? l : q; };
        b.b("observable", b.m);
        b.b("isObservable", b.$);
        ...
        b.R.fn = {
            remove: function(a) {
                for (var b = this.t(), c = [], e = "function" == typeof a ? a : function(b) { return b === a; }, f = 0; f < b.length; f++) {
                    var g = b[f];
            ...
            removeAll: function(a) {
                ...
                return !a ? [] : this.remove(function(d) { return 0 <= b.a.i(a, d); });
            },
            destroy: function(a) {
            ...
            destroyAll: function(a) { return a === H ? this.destroy(t(l)) : !a ? [] : this.destroy(function(d) { return 0 <= b.a.i(a, d); }); },
            indexOf: function(a) {
                var d = this();
                return b.a.i(d, a);
            },
        ...
        b.j = function(a, d, c) {
            ...
            function g() {
                if (!p)
                    if (m && v()) z();
                        ...
                        p = l;
                        try {
                            var a = b.a.V(y, function(a) { return a.target; });
                            b.r.lb(function(c) {
                                var d;
            ...
            function j() { return !m || 0 < y.length; }
            ...
            if (F && j()) {
                ...
                b.a.F.Ba(F, z);
                var C = v, v = function() { return !b.a.X(F) || C(); };
            }
            return h;
        };
        b.Ab = function(a) { return b.la(a, b.j); };
        v = b.m.Jb;
        b.j[v] = b.m;
        b.j.fn = {};
        b.j.fn[v] = b.j;
        ...
        b.g = {
            ...
            aa: function(a) {
                ...
                d = d.split(",");
                c = 0;
                for (f = d.length; c < f; c++) j = d[c], k = j.indexOf(":"), 0 < k && k < j.length - 1 ? (g = j.substring(k + 1), e.push({ key: O(j.substring(0, k), a), value: O(g, a) })) : e.push({ unknown: O(j, a) });
                return e;
            },
            ba: function(a) {
        ...
        b.e = {
            I: {},
            childNodes: function(a) { return A(a) ? $(a) : a.childNodes; },
            Y: function(a) {
            ...
            Ua: function(a, b) { A(a) ? a.parentNode.insertBefore(b, a.nextSibling) : a.firstChild ? a.insertBefore(b, a.firstChild) : a.appendChild(b); },
            Oa: function(a, d, c) {
                c ? A(a) ? a.parentNode.insertBefore(d,
                    c.nextSibling) : c.nextSibling ? a.insertBefore(d, c.nextSibling) : a.appendChild(d) : b.e.Ua(a, d);
            },
            firstChild: function(a) { return !A(a) ? a.firstChild : !a.nextSibling || G(a.nextSibling) ? n : a.nextSibling; },
            nextSibling: function(a) {
                A(a) && (a = Z(a));
                return a.nextSibling && G(a.nextSibling) ? n : a.nextSibling;
            },
            ib: function(a) { return (a = A(a)) ? a[1] : n; },
            Sa: function(a) {
                if (oa[b.a.u(a)]) {
                    var d = a.firstChild;
                    if (d) {
        ...
        b.z.prototype.createChildContext = function(a, d) { return new b.z(a, this, d); };
        ...
        b.Da = function(a, b) { (1 === b.nodeType || 8 === b.nodeType) && Y(a, b, l); };
        b.Ca = function(a, b) {
        ...
        b.ob = function(a) { return (a = b.ja(a)) ? a.$data : H; };
        ...
        b.c.disable = { update: function(a, d) { b.c.enable.update(a, function() { return !b.a.d(d()); }); } };
        b.c.event = {
        ...
        b.c.foreach = {
            ...
            init: function(a, d) { return b.c.template.init(a, b.c.foreach.Ra(d)); },
            update: function(a, d, c, e, f) { return b.c.template.update(a, b.c.foreach.Ra(d), c, e, f); }
        };
        b.g.Q.foreach = q;
        b.e.I.foreach = l;
        b.c.hasfocus = {
        ...
        b.c.html = { init: function() { return { controlsDescendantBindings: l }; }, update: function(a, d) { b.a.ca(a, d()); } };
        ...
        b.c.options = {
            update: function(a, d, c) {
                ...
                for (var e = 0 == a.length, f = b.a.V(b.a.fa(a.childNodes, function(a) { return a.tagName && "option" === b.a.u(a) && a.selected; }), function(a) { return b.k.q(a) || a.innerText || a.textContent; }), g = a.scrollTop, h = b.a.d(d()); 0 < a.length;) b.A(a.options[0]), a.remove(0);
                if (h) {
        ...
        b.c.selectedOptions = {
            init: function(a, d, c) {
                b.a.n(a, "change", function() {
                    var e = d(), f = [];
                    b.a.o(a.getElementsByTagName("option"), function(a) { a.selected && f.push(b.k.q(a)); });
                    b.g.ea(e, c, "value", f);
                });
            },
            update: function(a, d) {
        ...
        b.c.text = { update: function(a, d) { b.a.bb(a, d()); } };
        b.e.I.text = l;
        b.c.uniqueName = {
            init: function(a, d) {
                if (d()) {
        ...
        b.c.value = {
            init: function(a, d, c) {
                ...
                if (b.a.Z && ("input" == a.tagName.toLowerCase() && "text" == a.type && "off" != a.autocomplete && (!a.form || "off" != a.form.autocomplete)) && -1 == b.a.i(f, "propertychange")) b.a.n(a, "propertychange", function() { h = l; }), b.a.n(a, "blur", function() { h && e(); });
                b.a.o(f, function(c) {
                    var d = e;
            ...
            update: function(a, d) {
                ...
                0 === e && (0 !== f && "0" !== f) && (g = l);
                g && (f = function() { b.k.T(a, e); }, f(), c && setTimeout(f, 0));
        ...
        b.v.prototype.renderTemplateSource =
            function() { i(Error("Override renderTemplateSource")); };
        b.v.prototype.createJavaScriptEvaluatorBlock = function() { i(Error("Override createJavaScriptEvaluatorBlock")); };
        ...
        b.v.prototype.isTemplateRewritten = function(a, b) { return this.allowTemplateRewriting === q ? l : this.makeTemplateSource(a, b).data("isRewritten"); };
        ...
        b.ya = {
            ub: function(a,
                d, c) {
                d.isTemplateRewritten(a, c) || d.rewriteTemplate(a, function(a) { return b.ya.Fb(a, d); }, c);
            },
            Fb: function(a, b) { return a.replace(pa, function(a, e, f, g, h, j, k) { return V(k, e, b); }).replace(qa, function(a, e) { return V(e, "<\!-- ko --\>", b); }); },
            jb: function(a) { return b.s.qa(function(d, c) { d.nextSibling && b.Ea(d.nextSibling, a, c); }); }
        };
        b.b("__tr_ambtns", b.ya.jb);
        b.l = {};
        b.l.h = function(a) { this.h = a; };
        ...
        b.ua = function(a, d, c, e, f) {
            ...
            if (e) {
                ...
                }, n, { Ja: function() { return !g || !b.a.X(g); }, W: g && "replaceNode" == f ? g.parentNode : g });
            }
            return b.s.qa(function(e) { b.ua(a, d, c, e, "replaceNode"); });
        };
        b.Lb = function(a, d, c, e, f) {
            ...
            return b.j(function() {
                ...
                a = b.a.fa(a, function(a) { return c.includeDestroyed || a === H || a === n || !b.a.d(a._destroy); });
        ...
        b.a.Za = function(a, d, c, e, f) {
            ...
            for (var d = d || [], e = e || {}, j = b.a.f.get(a, "setDomNodeChildrenFromArrayMapping_lastMappingResult") === H, k = b.a.f.get(a, "setDomNodeChildrenFromArrayMapping_lastMappingResult") || [], m = b.a.V(k, function(a) { return a.U; }), p = b.a.Ia(m, d), r = [], u = 0, v = 0, A = [], z = [], d = [], y = [], m = [], s, C = 0, B, D; B = p[C]; C++)
        ...
        b.pa = function() {
            ...
            this.addTemplate = function(a, b) { x.write("<script type='text/html' id='" + a + "'>" + b + "<\/script>"); };
